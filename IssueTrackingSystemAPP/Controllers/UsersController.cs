...
namespace IssueTrackingSystemAPP.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,Name,UserName,Email,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Name,UserName,Email,Password")] User user)
        {
            if (ModelState.IsValid)
            {
