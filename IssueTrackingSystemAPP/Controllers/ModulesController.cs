...
namespace IssueTrackingSystemAPP.Controllers
{
    public class ModulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ModuleId,Name,AddedDate,AddedBy")] Module module)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ModuleId,Name,AddedDate,AddedBy")] Module module)
        {
            if (ModelState.IsValid)
            {
